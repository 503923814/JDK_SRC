...
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_EXPLICIT_COMPLETE;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_FRAGMENT_INTERLEAVE;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_INIT_MAXSTREAMS;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_NODELAY;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_PRIMARY_ADDR;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SCTP_SET_PEER_PRIMARY_ADDR;
import static com.sun.nio.sctp.SctpStandardSocketOptions.SO_LINGER;
    ...
    private void removeAssociation(Association association) {
        synchronized (stateLock) {
            ...
            if (addresses != null) {
                ...
                Set<Entry<SocketAddress, Association>> addrAssocs =
                        addressMap.entrySet();
