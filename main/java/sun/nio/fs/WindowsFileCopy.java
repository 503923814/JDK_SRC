...
import static sun.nio.fs.WindowsConstants.COPY_FILE_COPY_SYMLINK;
...
import static sun.nio.fs.WindowsConstants.ERROR_NOT_SAME_DEVICE;
import static sun.nio.fs.WindowsConstants.GROUP_SECURITY_INFORMATION;
import static sun.nio.fs.WindowsConstants.MOVEFILE_COPY_ALLOWED;
import static sun.nio.fs.WindowsConstants.MOVEFILE_REPLACE_EXISTING;
...
import static sun.nio.fs.WindowsNativeDispatcher.CopyFileEx;
...
import static sun.nio.fs.WindowsNativeDispatcher.MoveFileEx;
