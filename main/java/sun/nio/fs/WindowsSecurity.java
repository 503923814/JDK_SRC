...
import static sun.nio.fs.WindowsConstants.SE_PRIVILEGE_ENABLED;
import static sun.nio.fs.WindowsConstants.TOKEN_ADJUST_PRIVILEGES;
import static sun.nio.fs.WindowsConstants.TOKEN_DUPLICATE;
import static sun.nio.fs.WindowsConstants.TOKEN_IMPERSONATE;
import static sun.nio.fs.WindowsConstants.TOKEN_QUERY;
import static sun.nio.fs.WindowsNativeDispatcher.AccessCheck;
import static sun.nio.fs.WindowsNativeDispatcher.AdjustTokenPrivileges;
import static sun.nio.fs.WindowsNativeDispatcher.CloseHandle;
import static sun.nio.fs.WindowsNativeDispatcher.DuplicateTokenEx;
import static sun.nio.fs.WindowsNativeDispatcher.GetCurrentProcess;
import static sun.nio.fs.WindowsNativeDispatcher.GetCurrentThread;
import static sun.nio.fs.WindowsNativeDispatcher.LocalFree;
import static sun.nio.fs.WindowsNativeDispatcher.LookupPrivilegeValue;
import static sun.nio.fs.WindowsNativeDispatcher.OpenProcessToken;
import static sun.nio.fs.WindowsNativeDispatcher.OpenThreadToken;
import static sun.nio.fs.WindowsNativeDispatcher.SetThreadToken;
